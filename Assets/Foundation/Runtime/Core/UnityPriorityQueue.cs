...
namespace DarkNaku.Foundation
{
    ...
    /// </remarks>
    public class UnityPriorityQueue<TElement, TPriority>
    {
        /// <summary>
        ...
        /// <summary>
        ///  Initializes a new instance of the <see cref="UnityPriorityQueue{TElement, TPriority}"/> class.
        /// </summary>
        public UnityPriorityQueue()
        {
        ...
        public UnityPriorityQueue(int initialCapacity)
        ...
        /// </param>
        public UnityPriorityQueue(IComparer<TPriority>? comparer)
        {
            _nodes = Array.Empty<(TElement, TPriority)>();
        ...
        ///  Uses <see cref="Comparer{T}.Default" /> if the argument is <see langword="null"/>.
        /// </param>
        public UnityPriorityQueue(int initialCapacity, IComparer<TPriority>? comparer)
        {
        ...
        /// </remarks>
        public UnityPriorityQueue(IEnumerable<(TElement Element, TPriority Priority)> items)
        ...
        ///  which is generally faster than enqueuing individual elements sequentially.
        /// </remarks>
        public UnityPriorityQueue(IEnumerable<(TElement Element, TPriority Priority)> items, IComparer<TPriority>? comparer)
        {
            if (items == null) 
            {
                throw new ArgumentNullException("[PriorityQueue] Constructor : Items cannot be null.");
            }
        ...
        /// <summary>
        ///  Gets the number of elements contained in the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.
        /// </summary>
        public int Count => _size;

        /// <summary>
        ///  Gets the priority comparer used by the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Adds the specified element with associated priority to the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.
        /// </summary>
        /// <param name="element">The element to add to the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.</param>
        ...
        /// <summary>
        ///  Returns the minimal element from the <see cref="UnityPriorityQueue{TElement, TPriority}"/> without removing it.
        /// </summary>
        /// <exception cref="InvalidOperationException">The <see cref="UnityPriorityQueue{TElement, TPriority}"/> is empty.</exception>
        /// <returns>The minimal element of the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.</returns>
        public TElement Peek()
        {
            if (_size == 0)
            {
                throw new InvalidOperationException("[PriorityQueue] Peek : The queue is empty.");
            }
        ...
        /// <summary>
        ///  Removes and returns the minimal element from the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Removes the minimal element and then immediately adds the specified element with associated priority to the <see cref="UnityPriorityQueue{TElement, TPriority}"/>,
        /// </summary>
        /// <param name="element">The element to add to the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.</param>
        /// <param name="priority">The priority with which to associate the new element.</param>
        /// <exception cref="InvalidOperationException">The queue is empty.</exception>
        ...
        /// <summary>
        ///  Removes the minimal element from the <see cref="UnityPriorityQueue{TElement, TPriority}"/>,
        ...
        ///  <see langword="false"/> if the <see cref="UnityPriorityQueue{TElement, TPriority}"/> is empty.
        /// </returns>
        ...
        /// <summary>
        ///  Returns a value that indicates whether there is a minimal element in the <see cref="UnityPriorityQueue{TElement, TPriority}"/>,
        ///  and if one is present, copies it to the <paramref name="element"/> parameter,
        ///  and its associated priority to the <paramref name="priority"/> parameter.
        ///  The element is not removed from the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Enqueues a sequence of element/priority pairs to the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Enqueues a sequence of elements pairs to the <see cref="UnityPriorityQueue{TElement, TPriority}"/>,
        ...
        /// <summary>
        ///  Removes all items from the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.
        /// </summary>
        public void Clear()
        {
        ...
        /// <summary>
        ///  Ensures that the <see cref="UnityPriorityQueue{TElement, TPriority}"/> can hold up to
        ...
        /// <returns>The current capacity of the <see cref="UnityPriorityQueue{TElement, TPriority}"/>.</returns>
        ...
        /// <summary>
        ///  Sets the capacity to the actual number of items in the <see cref="UnityPriorityQueue{TElement, TPriority}"/>,
        ...
        /// <summary>
        ///  Enumerates the contents of a <see cref="UnityPriorityQueue{TElement, TPriority}"/>, without any ordering guarantees.
        /// </summary>
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>, ICollection
        {
            internal readonly UnityPriorityQueue<TElement, TPriority> _queue;

            internal UnorderedItemsCollection(UnityPriorityQueue<TElement, TPriority> queue) => _queue = queue;
            ...
            void ICollection.CopyTo(Array array, int index)
            {
                if (array.Rank != 1)
                {
                    throw new InvalidOperationException("[PriorityQueue] CopyTo : The rank is not 1."); 
                }

                if (array.GetLowerBound(0) != 0)
                {
                    throw new InvalidOperationException("[PriorityQueue] CopyTo : The lower bound is not 0."); 
                }

                if (index < 0 || index > array.Length)
                {
                    throw new InvalidOperationException("[PriorityQueue] CopyTo : The index is out of range."); 
                }

                if (array.Length - index < _queue._size)
                {
                    throw new InvalidOperationException("[PriorityQueue] CopyTo : The array is too small."); 
                }
                ...
                {
                    throw new InvalidOperationException("[PriorityQueue] CopyTo : Array type mismatch."); 
                }
            }

            /// <summary>
            ///  Enumerates the element and priority pairs of a <see cref="UnityPriorityQueue{TElement, TPriority}"/>,
            ///  without any ordering guarantees.
            /// </summary>
            public struct Enumerator : IEnumerator<(TElement Element, TPriority Priority)>
            {
                private readonly UnityPriorityQueue<TElement, TPriority> _queue;
                private readonly int _version;
                private int _index;
                private (TElement, TPriority) _current;

                internal Enumerator(UnityPriorityQueue<TElement, TPriority> queue)
                {
                    _queue = queue;
                    _index = 0;
                ...
                {
                    UnityPriorityQueue<TElement, TPriority> localQueue = _queue;
                ...
                private bool MoveNextRare()
                {
                    ...
                    {
                        throw new InvalidOperationException("[PriorityQueue] MoveNextRare : Version mismatch."); 
                    }
